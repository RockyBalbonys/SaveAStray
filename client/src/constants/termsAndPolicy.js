const myTerms = [
  ...
  {
    item: "8. Changes to Terms:",
    content: [
      "We reserve the right to modify these Terms at any time. The revised Terms will be effective immediately upon posting on the website. Your continued use of SaveAStray after the posting of the revised Terms constitutes your acceptance of the revised Terms.",
    ],
  },
  {
  ...
  },
  {
    item: "10. Contact Us:",
    content: [
      "If you have any questions about these Terms, please contact us at saveastray.lyfie@gmail.com.",
    ],
  },
];

const myPolicy = [
  "<strong>Your privacy is important to us.</strong> This Privacy Policy explains how SaveAStray collects, uses, and discloses information about you when you visit and use our website and services.",
  {
    item: "1. Information We Collect:",
    content: [
      "Personally Identifiable Information (PII): We may collect the following PII from you:",
      "Name",
      "Email address",
      "Phone number",
      "Demographic information (age, gender, etc.)",
      "Information about your pets, including photos and descriptions",
      "Adoption-related information, such as adoption history and preferences",
    ],
  },
  {
  ...
  {
    item: "3. Sharing Your Information:",
    content: [
  ...
  },
  {
    ...
    content: [
      "We take reasonable security measures to protect your information from unauthorized access, disclosure, alteration, or destruction. However, no security measure is perfect, and we cannot guarantee the complete security of any information you transmit to us.",
    ],
  },
  {
    item: "5. Cookies and Tracking Technologies:",
    content: [
      "We use cookies and other tracking technologies to track user activity on our website and to hold certain information. You can configure your browser to reject cookies or to alert you when a cookie is placed on your device. However, if you disable cookies, some features of our website may not function properly.",
    ],
  },
  {
    item: "6. Your Choices:",
  ...
  {
    item: "7. Changes to this Privacy Policy:",
    content: [
      "We may update this Privacy Policy from time to time. We will post any changes on this page. We encourage you to review this Privacy Policy periodically for the latest information about our privacy practices.",
    ],
  },
  {
    item: "Contact Us:",
    content: [
      "If you have any questions about this Privacy Policy, please contact us at saveastray.lyfie@gmail.com.",
    ],
  },
];

export { myTerms, myPolicy };
