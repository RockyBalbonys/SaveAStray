    ...
    <div className="flex flex-col md:flex-row justify-center items-start gap-6">
      ...
      <div className="flex flex-col items-center gap-6">
        <Accordion title="What is the process for finalizing the adoption after the shelter approves my request?">
          Visit the local shelter to complete the adoption paperwork. Our system
          streamlines this process, ensuring a smooth transition from online
          selection to in-person finalization.
        </Accordion>
        <Accordion title="Can I interact with the online before making a decision to adopt through your system?">
          Absolutely. Our platform encourages users to explore and interact with
          pets before making a decision. Log in to your account, browse through
          profiles, and find the perfect match for your lifestyle.
        </Accordion>
        ...
        <Accordion title="Is there a trial period or return policy if the adopted pet doesn't fit into my home after finalizing the paperwork?">
          ...
          policies are in place, emphasizing early communication for resolution.
        </Accordion>
      </div>
    </div>
  </div>
